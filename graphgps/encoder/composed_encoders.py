...
from graphgps.encoder.kernel_pos_encoder import HKdiagSENodeEncoder
from graphgps.encoder.kernel_pos_encoder import ElstaticSENodeEncoder
...
def concat_node_encoders(encoder_classes, pe_enc_names):
    ...
    class Concat2NodeEncoder(torch.nn.Module):
        ...
        def __init__(self, dim_emb):
            ...
            """
            Special handling for Equiv_Stable LapPE where node feats and PE 
            are not concat
            """
...
ds_encs = {'TypeDictNode': TypeDictNodeEncoder}
