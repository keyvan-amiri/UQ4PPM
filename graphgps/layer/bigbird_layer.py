"""
Source code adapted from HuggingFace: 
    https://huggingface.co/transformers/v4.9.2/_modules/transformers/models/big_bird/modeling_big_bird.html#BigBirdModel
"""
